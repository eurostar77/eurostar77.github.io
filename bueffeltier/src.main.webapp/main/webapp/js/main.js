...
// FlipCard Flip Button:
    ...
    modelCard = document.getElementById('card1')
    
    addBtn = document.getElementById('addBtn');
    
    if(addBtn!==null){addBtn.addEventListener('click', function()
            {
                // New Card:
...
//                clonedCard.getElementById('ch1').id = 'ch2' + newIdNumber;
                clonedCard.querySelector('h3').innerHTML = 'Karte ' + newIdNumber;
                clonedCard.querySelector('h3').id = 'ch' + newIdNumber;
