 ...
 */
public class PageJDBCFlat implements java.io.Serializable
{
	...
	// todo
	public PageJDBCFlat getCreate(String internalName)
	{
		return new PageJDBCFlat(internalName);
	}

	public PageJDBCFlat(String internalName)
	{
//		init();
		initForJDBC();
...
//	}
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		PageJDBCFlat other = (PageJDBCFlat) obj;
		return
