 ...
 */
public class FrageAntwortDaoImpl
        extends GenericDaoImpl<FrageAntwort, Integer>
        implements FrageAntwortDao
{

    //todo: schnellere suche nicht über entity sondern über dto projections bei Read-Only Operations
    /**
     *
     * @return
     */
    ...
    public List<FrageAntwort> findAllAsc(int parentPageId)
    {
        ...
        try
        {
            ...
            NativeQuery query = session.createSQLQuery(sql)
                    .addEntity(FrageAntwort.class).setParameter("id", parentPageId); // todo: parameter als array zuweisen?
