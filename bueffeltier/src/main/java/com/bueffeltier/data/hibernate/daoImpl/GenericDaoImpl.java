...
public abstract class GenericDaoImpl<T, ID extends Serializable> implements GenericDao<T, ID>
{
    ...
    /**
     * Das übergebene Entity-Objekt wird gespeichert (INSERT)
...
//        session.close();
     ...
     * neue Kopie. Die Instanz, die Sie übergeben, wird nicht verwaltet
     * (alle Änderungen, die Sie vornehmen, sind nicht Teil der Transaktion
     * - es sei denn, Sie rufen Merge erneut auf).
     *
     * @param entity ffff
     */
    @Override
    ...
    public List<T> findAll(Class clazz, String sqlTableName)
    {
        ...
        try
        {
            ...
            objects = session.createNativeQuery(
                    "SELECT * FROM " + sqlTableName, clazz).getResultList();
            session.getTransaction().commit();
        } catch (HibernateException e)
        {
